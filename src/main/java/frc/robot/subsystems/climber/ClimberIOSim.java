...
import static frc.robot.subsystems.climber.ClimberConstants.gearReduction;
...
/**
 * Simulation IO for the subsystem.
 *
 ...
 * </ul>
 *
 * Tuning (velocityKp, velocityKd in {@link ClimberConstants}) balances response speed and
 * stability.
 */
public class ClimberIOSim implements ClimberIO {
  /** Simulates motor dynamics (Neo Vortex + gearbox) for physics-accurate behavior. */
  ...
  public void updateInputs(IndexIOInputs inputs) {
    ...
    inputs.extension =
        Inches.of(ClimberConstants.poleRadiusForRope).times(inputs.position.in(Radians));
  }
