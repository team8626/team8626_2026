...
import static frc.robot.subsystems.climber.ClimberConstants.encoderPositionFactor;
import static frc.robot.subsystems.climber.ClimberConstants.encoderVelocityFactor;
import static frc.robot.subsystems.climber.ClimberConstants.indexCanId;
import static frc.robot.subsystems.climber.ClimberConstants.motorCurrentLimit;
import static frc.robot.subsystems.climber.ClimberConstants.motorInverted;
import static frc.robot.subsystems.climber.ClimberConstants.velocityKd;
import static frc.robot.subsystems.climber.ClimberConstants.velocityKp;
import static frc.robot.subsystems.climber.ClimberConstants.velocityKs;
import static frc.robot.subsystems.climber.ClimberConstants.velocityKv;
...
/** Hardware IO for using a SPARK Flex. Velocity control only. */
public class ClimberIOSpark implements ClimberIO {
  ...
  public void updateInputs(IndexIOInputs inputs) {
    ...
    inputs.extension =
        Inches.of(ClimberConstants.poleRadiusForRope)
            .times(inputs.position.in(Radians)); // TODO: assuming the radius doesn't change
  }
